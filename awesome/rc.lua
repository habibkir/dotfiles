...
beautiful.get().wallpaper = "/home/diccu/Pictures/wallpapers/abbazia-querceto-croppy.jpg"
beautiful.get().useless_gap = 2
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "re1eload awesome", group = "awesome"}),
    ...
    -- emulate dmenu binding on sway config because I am weak
    awful.key({ "Mod1" },            "d",     function () awful.screen.focused().mypromptbox:run() end,
              {description = "run prompt", group = "launcher"}),

    awful.key({ "Mod4" },            "p",     function () awful.spawn("rofi -combi-modi drun -show combi -show-icons")  end,
              {description = "run prompt", group = "launcher"}),
...
awesome.spawn("setxkbmap -layout us,it -option grp:win_space_toggle")
-- }}}
